...
{
	public ArrayList<Column> getStructurTable(){
		 ArrayList<Column> columns = new ArrayList<Column>();
	 try {
		Class.forName("org.postgresql.Driver");
	 Connection   connexion = DriverManager.getConnection( "jdbc:postgresql://localhost:9090/test_vieExcel", "postgres", "radhoinbhk123456789");
